                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="featured-item">
                                <div class="thumb">
                                    <div class="thumb-img">
                                        <img src="<?= base_url('assets/shopping/img/blog-4-720x480.jpg') ?>" alt="">
                                    </div>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="featured-item">
                                <div class="thumb">
                                    <div class="thumb-img">
                                        <img src="<?= base_url('assets/shopping/img/blog-5-720x480.jpg') ?>" alt="">
                                    </div>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="featured-item">
                                <div class="thumb">
                                    <div class="thumb-img">
                                        <img src="<?= base_url('assets/shopping/img/blog-6-720x480.jpg') ?>" alt="">
                                    </div>
